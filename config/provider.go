...
func GetProvider() *ujconfig.Provider {
	var tfPluginFrameworkProvider provider.Provider
	if btp.IsDebug() {
		tfPluginFrameworkProvider = tfprovider.NewWithClient(btp.DebugPrintHTTPClient())
	} else {
		tfPluginFrameworkProvider = tfprovider.New()
	}
