...
func (e serviceinstanceExporter) Export(ctx context.Context, btpClient *btpcli.BtpCli, eventHandler export.EventHandler, _ bool) error {
	...
	for _, subaccountID := range selectedSubaccounts {
		...
		instances, err := btpClient.ListServiceInstances(ctx, subaccountID)
		if err != nil {
