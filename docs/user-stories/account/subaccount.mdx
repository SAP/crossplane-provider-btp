...
import NonExistentComponent from '@site/src/components/ThisDoesNotExist';
...
- You've [installed](/docs/crossplane-provider-btp/docs/user-stories/setup/install-provider-btp) and [configured](/docs/crossplane-provider-btp/docs/user-stories/setup/configure-provider-btp) the BTP provider.
...
1. Save the following YAML content to `subaccount.yaml`.
    ...
    - `<admin-email>`: The email address of [your technical user](/docs/crossplane-provider-btp/docs/user-stories/setup/configure-provider-btp/#create-and-validate-a-technical-user)
...
To create a Cloud Management service instance, you first need to entitle it. You can do that in code using [our `Entitlement` custom resource](/docs/crossplane-provider-btp/docs/user-stories/services/create-services#create-an-entitlement). 
...
2. Apply `entitlement-service-manager.yaml` to your control plane:
    ...
    Learn more about how to entitle services from our guide: [Order service instances and subscriptions](/docs/crossplane-provider-btp/docs/user-stories/services/create-services).
...
- [Configure the user access to your subaccount](/docs/crossplane-provider-btp/docs/user-stories/account/usermanagement).
- [Create services instances and subscriptions](/docs/crossplane-provider-btp/docs/user-stories/services/create-services).
- [Consume services](/docs/crossplane-provider-btp/docs/user-stories/services/consume-services).
...
To manage subaccount admins, use offerings such as [XSUAA](/docs/crossplane-provider-btp/docs/user-stories/account/usermanagement).
...
1. [The `ProviderConfig`](/docs/crossplane-provider-btp/docs/user-stories/setup/configure-provider-btp#create-a-providerconfig) references the correct global account subdomain.
