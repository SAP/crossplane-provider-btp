...
type XSUAACredentialsReference struct {
	...
	// +kubebuilder:validation:Optional
	SubaccountApiCredentialSelector *xpv1.NamespacedSelector `json:"subaccountApiCredentialSelector,omitempty"`
	// +kubebuilder:validation:Optional
	SubaccountApiCredentialRef *xpv1.NamespacedReference `json:"subaccountApiCredentialRef,omitempty" reference-group:"security.btp.sap.crossplane.io" reference-kind:"SubaccountApiCredential" reference-apiversion:"v1alpha1"`
