...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SBResource) DeepCopyInto(out *SBResource) {
	*out = *in
	if in.CreatedAt != nil {
		in, out := &in.CreatedAt, &out.CreatedAt
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SBResource.
func (in *SBResource) DeepCopy() *SBResource {
	if in == nil {
		return nil
	}
	out := new(SBResource)
...
func (in *ServiceBindingObservation) DeepCopyInto(out *ServiceBindingObservation) {
	*out = *in
	in.SBResource.DeepCopyInto(&out.SBResource)
	if in.RetiredKeys != nil {
		in, out := &in.RetiredKeys, &out.RetiredKeys
		*out = make([]*SBResource, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SBResource)
