...
func (in *SubaccountDestinationInitParameters) DeepCopyInto(out *SubaccountDestinationInitParameters) {
	*out = *in
	...
	if in.AdditionalConfigurationSecretRef != nil {
		in, out := &in.AdditionalConfigurationSecretRef, &out.AdditionalConfigurationSecretRef
...
func (in *SubaccountDestinationObservation) DeepCopyInto(out *SubaccountDestinationObservation) {
	*out = *in
	...
	if in.RawProperties != nil {
		in, out := &in.RawProperties, &out.RawProperties
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
