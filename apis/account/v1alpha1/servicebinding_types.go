...
type ServiceBindingSpec struct {
	...
	// BtpName is the unique name that will be used to create the service binding in BTP.
	// This is generated by the controller based on rotation settings and conflicts.
