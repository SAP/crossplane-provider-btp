...
type CfEnvironmentParameters struct {
	...
	// Each entry is either a plain email address (uses "sap.ids" as origin) or "email|origin" to specify a custom identity provider (e.g. "user@example.com|custom.idp").
