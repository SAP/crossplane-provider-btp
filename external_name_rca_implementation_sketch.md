...
2. Parse external-name; on parse failure return error.
...
- **P7 — Delete with valid annotation**: `managed.Delete` parses the key, calls `RevokeRole`, returns success. `Status.AtProvider` not used.
