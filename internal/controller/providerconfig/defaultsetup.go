...
func DefaultSetup(mgr ctrl.Manager, o internalopts.Options, object client.Object, kind string, gvk schema.GroupVersionKind, connectorFn ConnectorFn) error {
...
func DefaultSetupWithoutDefaultInitializer(mgr ctrl.Manager, o internalopts.Options, object client.Object, kind string, gvk schema.GroupVersionKind, connectorFn ConnectorFn) error {
	name := managed.ControllerName(kind)
...
func connectionPublishers(mgr ctrl.Manager, o internalopts.Options) managed.ReconcilerOption {
