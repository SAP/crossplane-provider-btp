...
func TestObserve(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"NeedsCreationInDifferentRegion": {
			reason: "Changed region should trigger creation of new subaccount",
			args: args{
		...
		"NeedsCreationWithDifferentSubdomain": {
			reason: "Changed subdomain should trigger creation of new subaccount",
			args: args{
				cr: NewSubaccount("unittest-sa", WithData(v1alpha1.SubaccountParameters{
					Description:       "someDesc",
