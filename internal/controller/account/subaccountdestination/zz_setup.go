...
// Setup adds a controller that reconciles SubaccountDestination managed resources.
func Setup(mgr ctrl.Manager, o internalopts.CrossplaneOptions) error {
	return providerconfig.DefaultSetupWithoutDefaultInitializer(
		mgr, o,
		&apisv1alpha1.SubaccountDestination{},
		apisv1alpha1.SubaccountDestination_GroupKind,
		apisv1alpha1.SubaccountDestination_GroupVersionKind,
