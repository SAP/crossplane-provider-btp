...
import (
	...
	logic "github.com/sap/crossplane-provider-btp/internal/controller/logic/account/directory"
...
const (
	...
	errConnectDirectory = "cannot connect to provider"
)
...
func Setup(mgr ctrl.Manager, o internalopts.CrossplaneOptions) error {
	return providerconfig.DefaultSetupWithoutDefaultInitializer(
		mgr, o,
		&apisv1alpha1.Directory{},
		apisv1alpha1.DirectoryGroupKind,
		apisv1alpha1.DirectoryGroupVersionKind,
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*apisv1alpha1.Directory)
	if !ok {
	...
	if err != nil {
		return nil, errors.Wrap(err, errConnectDirectory)
	}
