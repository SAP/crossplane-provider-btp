...
type ServiceOfferingResponseObject struct {
	...
	// The ID of the broker that provides the service offering.
	BrokerId *string `json:"broker_id,omitempty"`
	// The ID of the offering as provided in the broker catalog. This ID is used when Service Manager communicates with the service broker.
	...
	// The ID of the service offering, automatically generated by the Service Manager. This is the ID by which the offering is identified in the Service Manager database and which is used by the Service Manager API.
