...
func (o *DirectoryAssignmentsPatchUpdateRequestPayload) GetResources() []ExternalResourceRequestPayload {
...
// and a boolean to check if the value has been set.
func (o *DirectoryAssignmentsPatchUpdateRequestPayload) GetResourcesOk() ([]ExternalResourceRequestPayload, bool) {
	if o == nil || IsNil(o.Resources) {
		return nil, false
	}
...
func (o *DirectoryAssignmentsPatchUpdateRequestPayload) HasResources() bool {
	if o != nil && !IsNil(o.Resources) {
		return true
	}
...
func (o *DirectoryAssignmentsPatchUpdateRequestPayload) SetResources(v []ExternalResourceRequestPayload) {
	o.Resources = v
}
